...
<div class="container">
		<div class="row">
			<div class="col">
						<h4 class="h4 border-bottom border-info d-inline-block mb-2">Add Course</h4>
						
						<form:form action="/courses/new" method="POST" modelAttribute="courses" >
							...
							<div class="text-center pr-5">
								<input class="btn btn-warning " type="submit" value="Add Course"/>
							</div>
						</form:form>
			</div>
			<div class="col">
				<form:errors path="courses.*" element="p" cssClass="alert alert-danger"/>
			</div>
		</div>
	</div>
