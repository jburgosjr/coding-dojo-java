...
<body class="text-center bg-secondary">
      ...
      <main role="main" class="center inner cover ">
        <img src="/images/lookify_cans.png" width="200" height="200" alt="">
        
      </main>
      <div class="container mt-5">
      	<a href="/dashboard"><button type="button" class="btn btn-outline" style="color: orange; background:purple; border: solid 2px orange;">Start Looking!</button></a>
      </div>
